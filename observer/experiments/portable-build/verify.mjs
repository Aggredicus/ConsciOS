...
assert.match(first,/v0\.5 portable modular build · generated/);
...
assert.equal(entries.length,11,'portable module graph changed unexpectedly');
...
console.log(`Portable build verification passed: ${Buffer.byteLength(first)} bytes, SHA-256 ${firstHash}`);
