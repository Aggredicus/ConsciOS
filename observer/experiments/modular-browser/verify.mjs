...
for(const id of ['sensorium','workspace','worldModel','selfModel','counterfactual','metacognition','homeostasis','guardian','executive','expression','memory','trace'])assert.ok(html.includes(`id="${id}"`),`missing browser panel ${id}`);
