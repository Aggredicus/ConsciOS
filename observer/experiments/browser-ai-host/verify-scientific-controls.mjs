...
for(const forbidden of ['consciousness score','consciousnessScore','phenomenal score'])assert.ok(!ui.toLowerCase().includes(forbidden.toLowerCase()),`UI code contains prohibited aggregate score: ${forbidden}`);
assert.ok(html.includes('not a consciousness score'));
