...
function clampTokens(value){const n=Math.round(Number(value)||512);return Math.max(32,Math.min(4096,n))}
function responseTokens(){return clampTokens($('lengthNumber').value)}
function syncLength(source){const n=clampTokens(source.value);$('lengthNumber').value=n;$('lengthRange').value=Math.min(2048,n)}
