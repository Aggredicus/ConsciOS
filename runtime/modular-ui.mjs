...
function render(){
  ...
  $('expression').innerHTML=state.expression?`<div class="expression">${esc(state.expression.content)}</div><p class="small">Rendered from the Expression event generated by the modular causal loop.</p>`:'<div class="empty">No expression has been generated.</div>';
